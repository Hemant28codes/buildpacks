...
func TestProcfileProcesses(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			want: []libcnb.Process{
				{Type: "web", Command: []string{"foo bar baz"}, Default: true},
			},
		},
		{
			name:    "dollar sign",
		...
		},
		{
			...
			content: "web:foo",
			want: []libcnb.Process{
				{Type: "web", Command: []string{"foo"}, Default: true},
			},
		},
		{
...
`,
			want: []libcnb.Process{
				{Type: "dev", Command: []string{"java --foo=web:something"}},
				{Type: "web", Command: []string{"bar baz"}, Default: true},
			},
		},
		{
...
`,
			want: []libcnb.Process{
				{Type: "web", Command: []string{"bar"}, Default: true},
			},
		},
		{
...
`,
			want: []libcnb.Process{
				{Type: "web", Command: []string{"foo bar"}, Default: true},
				{Type: "release", Command: []string{"baz"}},
				{Type: "dev", Command: []string{"foo"}},
			},
		},
	}
	for _, tc := range testCases {
