...
func TestAddProcess(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			cmd:  []string{"/web"},
			want: []libcnb.Process{
				libcnb.Process{Command: []string{"/web"}, Type: "web"},
			},
		},
		{
			...
			cmd:  []string{"/web"},
			initial: []libcnb.Process{
				libcnb.Process{Command: []string{"/dev"}, Type: "dev"},
				libcnb.Process{Command: []string{"/cli"}, Type: "cli"},
			},
			want: []libcnb.Process{
				libcnb.Process{Command: []string{"/dev"}, Type: "dev"},
				libcnb.Process{Command: []string{"/cli"}, Type: "cli"},
		...
		},
		{
			...
			want: []libcnb.Process{
				libcnb.Process{Command: []string{"/dev"}, Type: "dev"},
				libcnb.Process{Command: []string{"/cli"}, Type: "cli"},
				libcnb.Process{Command: []string{"/OVERRIDE"}, Type: "web"},
			},
		},
		{
			desc: "no args",
			...
			cmd:  []string{"/start"},
			want: []libcnb.Process{
				libcnb.Process{Command: []string{"/start"}, Type: "foo"},
			},
		},
		{
			desc: "with args",
